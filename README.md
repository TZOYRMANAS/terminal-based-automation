...
* Μία παρατήρηση που ήθελα να κάνω είναι ότι στην τελική αναφορά δεν εμφανίζονται τα κομμίτ που έκανα όλο το εξάμηνο ,καθώς αντιμέτωπισα ένα θέμα με το τελικό pull request και αφου το έκλεισα για να στείλω καινούργιο  ,διέγραψα καταλάθος και το branch που είχα κάνει και δημιούργησα νέο .
